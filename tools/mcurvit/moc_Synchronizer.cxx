...
static const char qt_meta_stringdata_Synchronizer[] = {
    "Synchronizer\0synchronized()\0\0"
};
...
const QMetaObjectExtraData Synchronizer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Synchronizer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Synchronizer,
      qt_meta_data_Synchronizer, &staticMetaObjectExtraData }
};
...
void *Synchronizer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Observer"))
        return static_cast< Observer*>(const_cast< Synchronizer*>(this));
...
// SIGNAL 0
void Synchronizer::synchronized()
{
